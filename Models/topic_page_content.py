...
class TopicPageContent(Document):
    ...
    page_type=StringField(choices=['content','quiz','question_bank','test','mcq','match','fillups','content','expand','update','trueorfalse','analysis','active_recall','active_recall_content','active_recall_test','adaptive_learning_test','adaptive_learning_content',"materials"], required=True)
